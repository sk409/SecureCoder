...
struct PHPSyntaxHighlighter: CodeSyntaxHighlighter {
    ...
    private func appendAttributedString(_ decoratedString: NSMutableAttributedString, string: String, color: UIColor) {
        decoratedString.append(NSAttributedString(string: string, attributes: [NSAttributedString.Key.foregroundColor: color, NSAttributedString.Key.font: font]))
    }

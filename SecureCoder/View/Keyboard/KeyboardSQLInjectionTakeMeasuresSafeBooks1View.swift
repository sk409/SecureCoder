...
class KeyboardSQLInjectionTakeMeasuresSafeBook1View: KeyboardView {
    ...
    private func setupViews() {
        ...
        alignButtons(groups: [one, comma, space, openParentheses, closeParentheses], [bindValue, author], [pdo, colon, paramStr])
    }

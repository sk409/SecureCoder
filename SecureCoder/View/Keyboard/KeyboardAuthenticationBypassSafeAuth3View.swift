...
class KeyboardAuthenticationBypassSafeAuth3View: KeyboardView {
    ...
    private func setupViews() {
        ...
        alignButtons(groups: [one, comma, space, openParentheses, closeParentheses], [bindValue, password], [pdo, colon, paramStr])
    }

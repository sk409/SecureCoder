...
//        let course = Application.shared.courses[indexPath.item]
//        let lessonSelectionViewController = LessonSelectionViewController()
//        lessonSelectionViewController.course = course
//        present(lessonSelectionViewController, animated: true, completion: nil)
//    }

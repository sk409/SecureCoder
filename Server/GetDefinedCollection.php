...
$getter = "<?php echo json_encode(array_merge(array_merge(array_keys(get_defined_vars()), array_keys(get_defined_constants())), iterator_to_array(new RecursiveIteratorIterator(new RecursiveArrayIterator(get_defined_functions())), false))); ?>";
